...
3. Extract the name of the medication mentioned.
4. Return ONLY valid JSON with the tags:
{ "tags": ["<tag1>"], "custom_tags": ["<custom1>"], "drug": "<nome_do_medicamento_ou_null>", "confidence": <0.0-1.0> }
...
Examples:
  "Qual o princípio ativo do Paracetamol?" → { "tags": ["active_ingredient"], "custom_tags": ["princípio ativo"], "drug": "Paracetamol", "confidence": 0.97 }
  "Posso dar para meu filho de 10kg?" → { "tags": ["dosage_by_weight"], "custom_tags": ["criança 10kg"], "drug": null, "confidence": 0.91 }
  "Qual a dose de acetilcisteína para intoxicação por paracetamol?" → { "tags": ["dosage_adult"], "custom_tags": ["intoxicação paracetamol"], "drug": "acetilcisteína", "confidence": 0.95 }
  "Como o ibuprofeno age no corpo?" → { "tags": ["mechanism_of_action"], "custom_tags": ["ação no corpo"], "drug": "ibuprofeno", "confidence": 0.88 }
  "Como guardar este medicamento?" → { "tags": ["storage_conditions"], "custom_tags": ["armazenamento"], "drug": null, "confidence": 0.96 }
...
Examples with CONVERSATION CONTEXT (drug from previous messages):
  ...
  → "Quais os efeitos colaterais então?" → { "tags": ["common_side_effects"], "drug": "Rivotril", "confidence": 0.91 }

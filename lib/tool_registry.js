    ...
    inputSchema: {
      ...
      properties: {
        ...
        section:   { 
          ...
          enum: [
            "contraindicacao", "posologia", "indicacao", "reacoes", "advertencias",
            "superdosagem", "superdose", "armazenamento", "apresentacao", "composicao",
            "interacoes", "farmacodinamica", "farmacocinetica", "farmacologia", "preclinica",
            "mecanismo", "legal", "outros"
          ]
        },
        mode:      { type: "string", enum: ["patient", "professional"], description: "Modo do usuário" },
      },
